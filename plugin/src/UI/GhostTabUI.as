namespace GhostTabUI {
    ...
    void Render(LeaderboardRecord@ record, const vec2 &in anchorScreen, bool rowHovered) {
        ...
        bool expanded = ShouldExpand(record, rowHovered);
        ...
        UI::SetNextWindowPos(
            int(anchorScreen.x - tabWidth + 3.0f),
            int(anchorScreen.y - 2.0f)
        );
